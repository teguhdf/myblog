...
<div class="container"><br>
    <div class="row">
        <div class="col-md-9">
            <?php $__currentLoopData = $categories2->posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="post-item">
                    <div class="post-inner">
                        <div class="post-head clearfix">
                            ...
                            <div class="col-md-8">
                                <div class="detail">
                                    <h3 class="handle"><a href="<?php echo e(route('posts.show',$post->slug)); ?>"><?php echo e($post->title); ?></a></h3>
                                </div>
                                <div class="post-meta">
                                    <div>
