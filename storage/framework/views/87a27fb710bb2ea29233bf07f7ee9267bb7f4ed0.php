<div class="col-md-3">
    <div class="list-group" style="box-shadow: 0 0px 1px 0px rgba(0, 0, 0, 0.26);">
       ...
       Total <?php echo e($tags->total()); ?> Tags <small class="pull-right">Lihat Semua  <i class="fa fa-share "></i> </small></a>
    ...
    <div class="list-group" style="box-shadow: 0 0px 1px 0px rgba(0, 0, 0, 0.26);">
      ...
      <a href="<?php echo e(route('category.index')); ?>" class="list-group-item active">Total <?php echo e($categories->total()); ?> Kategori <small class="pull-right">Lihat Semua  <i class="fa fa-share "></i> </small> </a>
